...
var lyr_Industrias_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Industrias<br />\
    <img src="styles/legend/Industrias_2_0.png" /> <br />\
    <img src="styles/legend/Industrias_2_1.png" /> 100 personas<br />\
    <img src="styles/legend/Industrias_2_2.png" /> 250 personas<br />\
    <img src="styles/legend/Industrias_2_3.png" /> 30 personas<br />\
    <img src="styles/legend/Industrias_2_4.png" /> 50 personas<br />\
    <img src="styles/legend/Industrias_2_5.png" /> <br />'
        });
...
lyr_GoogleHybrid_0.setVisible(true);lyr_UFP_1.setVisible(true);lyr_Industrias_2.setVisible(true);lyr_mun_utm_3.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_UFP_1,lyr_Industrias_2,lyr_mun_utm_3];
...
lyr_Industrias_2.set('fieldLabels', {'nom_estab': 'inline label - always visible', 'per_ocu': 'inline label - always visible', });
